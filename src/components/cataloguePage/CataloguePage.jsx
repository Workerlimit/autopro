...
const CataloguePage = () => {
    ...
    const ref = useRef();
    const ref2 = useRef();
    useOnClickOutside(ref2, () => setIsLike(false));
    return (
        <div className="page-wrapper">
            <div className="container">
                <div className="page-top">
                    <a href="/catalogue"><div className="goback-btn"></div></a>
                    ...
                    <div className="page-content">
                        ...
                        <div className="page-text">
                            <div className="cart-item__content">
                                <div className="cart-item__service-name">{ cartContent.serviceName }</div>
                                    ...
                                    <div className="cart-item__rating">
                                        ...
                                        <span className="rate">( { cartContent.rating } / 5 )</span>
                                    </div>
                            ...
                            <PhoneModal ref={ref} isPhone={isPhone} setIsPhone={setIsPhone}/>
                            <CSSTransition
                                in={isLike}
                                timeout={200}
                            ...
                            >
                                <div className="like-popup">
                                    <div className="like-popup__content" ref={ref2}>
                                    <Rating
                                        name="half-rating"
                                        precision={0.5}
                                    />
